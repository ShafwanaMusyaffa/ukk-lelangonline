...
class LelangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.lelang.index', ['lelang' => $lelang]);
    }
    ...
    public function create(Asset $asset)
    {
        ...
        return view('admin.lelang.create', ['asset' => $asset]);
    }
    ...
    {
        return view('admin.lelang.show', ['lelang' => $lelang]);
    }
    ...
    {
        return view('admin.lelang.tawar', ['lelang' => $lelang]);
    }
