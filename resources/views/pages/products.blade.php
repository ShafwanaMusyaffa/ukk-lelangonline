        ...
        <div class="content-wrapper col-xl-9 col-lg-9 order-lg-2">
          <div class="block-category mb-30 w-100 float-left">
            <div class="category-cover">
              <img
                src="/client/img/banner/category-banner.png"
                alt="category-banner"
              />
            </div>
          </div>
          ...
          <div class="tab-content text-center products w-100 float-left">
            <div class="tab-pane grid fade active" id="grid" role="tabpanel">
              <div class="row">
                <div
                  class="product-layouts col-lg-3 col-md-3 col-sm-6 col-xs-6"
                >
                ...
                >
                  <div class="product-thumb">
                    ...
                    <div class="thumb-description">
                      <div class="caption">
                        <h4
                          class="product-title text-capitalize w-100 float-left"
                        >
                          <a href="product-details.html"
                ...
                >
                  <div class="product-thumb">
                    <div class="image zoom">
                      <a href="product-details.html">
                        <img src="/client/img/products/07.jpg" alt="03" />
                        <img
                          src="/client/img/products/08.jpg"
                          alt="08"
                          class="second_image img-responsive"
                        />
                      </a>
                ...
                >
                  <div class="product-thumb">
                    <div class="image zoom">
                      <a href="product-details.html">
                        <img src="/client/img/products/08.jpg" alt="08" />
                        <img
                          src="/client/img/products/09.jpg"
                          alt="09"
                          class="second_image img-responsive"
                        />
                      </a>
            ...
            <div
              class="tab-pane fade list text-left"
              id="list"
              role="tabpanel"
            >
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Integer erat purus, semper pharetra leo tincidunt,
                      commodo vestibulum nulla. Nam ultricies nisl sed maximus
                      rhoncus. Aliquam et ipsum pulvinar, rutrum erat nec,
                      aliquet nisl.
                    </div>
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Suspendisse eu mi ullamcorper, volutpat leo at,
                      consectetur arcu. Morbi eget tempor sem, sed auctor sem.
                      Nullam sodales scelerisque nisi, eu pellentesque felis
                      euismod malesuada.
                    </div>
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Phasellus euismod nulla nulla, sit amet tristique tellus
                      condimentum ut. Aenean posuere lacus eu ultrices
                      lobortis. Duis eget est arcu. Praesent rhoncus efficitur
                      augue nec porttitor.
                    </div>
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Sed nisi elit, gravida eu risus sit amet, hendrerit
                      tristique sapien. Proin consequat augue lectus, eu
                      tempor orci congue quis. Sed dapibus non enim sed
                      tristique. Donec commodo velit at odio gravida.
                    </div>
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Vestibulum semper tincidunt eros, ut pulvinar felis.
                      Maecenas tincidunt mi et dui dignissim, in feugiat nisl
                      scelerisque. Aenean et nisi turpis. Cras in nisi vitae
                      magna feugiat placerat id sit amet mauris.
                    </div>
                ...
                <div class="product-thumb row">
                  <div class="image zoom col-xs-12 col-sm-5 col-md-4">
                    <a
                      ...
                      class="d-block position-relative"
                    >
                      <img src="/client/img/products/07.jpg" alt="07" />
                      <img
                        src="/client/img/products/08.jpg"
                        alt="08"
                        class="second_image img-responsive"
                  ...
                  >
                    ...
                    <div class="description">
                      Phasellus ut felis eu libero semper elementum. Maecenas
                      sit amet scelerisque ante. Nam ultrices enim sed lacus
                      gravida condimentum. Proin at malesuada nibh.
                    </div>
              ...
              <div class="product-layouts">
                <div class="product-thumb row">
                  ...
                  >
                    ...
                    <div class="description">
                      Duis tincidunt ante urna, sit amet vestibulum felis
                      placerat in. Duis a tortor et odio consequat congue.
                      Mauris euismod augue tempor, sagittis nisl sed, pretium
                      purus.
                    </div>
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        ...
                        elit. Proin rhoncus arcu turpis, quis sagittis orci
                        dictum non. Etiam id eleifend erat. Donec sit amet
                        nisl id nisi laoreet viverra in ac nibh.
                      </div>
                      <div
                        class="color-option d-flex align-items-center float-left w-100"
                      >
                ...
                <div class="product-thumb row">
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Integer erat purus, semper pharetra leo tincidunt,
                        commodo vestibulum nulla. Nam ultricies nisl sed
                        maximus rhoncus. Aliquam et ipsum pulvinar, rutrum
                        erat nec, aliquet nisl.
                      </div>
                    </div>
                    <div
                      class="price-main col-md-3 col-sm-5 float-left text-center text-sm-center text-xs-left"
                ...
                <div class="product-thumb row">
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Suspendisse eu mi ullamcorper, volutpat leo at,
                        consectetur arcu. Morbi eget tempor sem, sed auctor
                        sem. Nullam sodales scelerisque nisi, eu pellentesque
                        felis euismod malesuada.
                      </div>
                    </div>
                    <div
                      class="price-main col-md-3 col-sm-5 float-left text-center text-sm-center text-xs-left"
                ...
                <div class="product-thumb row">
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Phasellus euismod nulla nulla, sit amet tristique
                        tellus condimentum ut. Aenean posuere lacus eu
                        ultrices lobortis. Duis eget est arcu. Praesent
                        rhoncus efficitur augue nec porttitor.
                      </div>
                    </div>
                    <div
                      class="price-main col-md-3 col-sm-5 float-left text-center text-sm-center text-xs-left"
                ...
                <div class="product-thumb row">
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Vestibulum semper tincidunt eros, ut pulvinar felis.
                        Maecenas tincidunt mi et dui dignissim, in feugiat
                        nisl scelerisque. Aenean et nisi turpis. Cras in nisi
                        vitae magna feugiat placerat id sit amet mauris.
                      </div>
                    </div>
                ...
                <div class="product-thumb row">
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Phasellus ut felis eu libero semper elementum.
                        Maecenas sit amet scelerisque ante. Nam ultrices enim
                        sed lacus gravida condimentum. Proin at malesuada
                        nibh.
                      </div>
                    </div>
                    <div
                  ...
                  >
                    <div class="sort-title col-md-5 col-sm-7 float-left">
                      ...
                      <div class="description mb-10">
                        Duis tincidunt ante urna, sit amet vestibulum felis
                        placerat in. Duis a tortor et odio consequat congue.
                        Mauris euismod augue tempor, sagittis nisl sed,
                        pretium purus.
                      </div>
                    </div>
                    <div
        ...
        <div class="left-column sidebar col-xl-3 col-lg-3 order-lg-1">
              ...
              <div class="sidebar-block categories">
                ...
                <div id="categoriesMenu" class="expand-lg collapse show">
                  <div class="nav nav-pills flex-column mt-4">
                    ...
                    <a
                      href="#"
                      class="nav-link d-flex justify-content-between mb-2 active"
                      ><span>Jeans &amp; chinos</span
                      ><span class="sidebar-badge"> 55</span></a
                    >
                    <div class="nav nav-pills flex-column ml-3">
          ...
          <div class="sidebar-left-banner left-sidebar w-100 float-left">
            <div class="ttleftbanner">
              <img src="/client/img/banner/left-banner.jpg" alt="left-banner" />
            </div>
          </div>
        </div>
      </div>
