...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('dashboard/library/simpleweather/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('dashboard/library/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('dashboard/library/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('dashboard/library/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('dashboard/library/summernote/dist/summernote-bs4.min.js') }}"></script>
    <script src="{{ asset('dashboard/library/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
